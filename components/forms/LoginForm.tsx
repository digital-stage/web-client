    ...
    <>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          password: Yup.string().min(8, f('passwordMinLength')).required(f('passwordRequired')),
        })}
      >
        {(props: FormikProps<any>) => (
          <AuthForm onReset={props.handleReset} onSubmit={props.handleSubmit} autoComplete="on">
            <Field
              as={Input}
