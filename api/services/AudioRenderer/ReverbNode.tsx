...
class SimpleReverb extends Effect {
    ...
    setup (reverbTime=1) {
        ...
        this.wet = this.context.createGain();e
...
const filter = new Filter(Audio, "lowpass", 50000, 0.8);
filter.setup();
const verb = new SimpleReverb(Audio);
verb.decayTime = 0.8;
...
class SimpleReverb extends AudioNode {
