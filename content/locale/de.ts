const de = {
    ...
    audioTypemediasoupDescription:
        'Übertragung mittels Web Audio. Benötigt keine zusätzliche Software, jedoch sind die Latenzen sehr hoch. Anwendungsbereiche: Theater',
    audioTypeJammer: 'Jammer',
    audioTypejammerDescription:
        'Übertragung mittels Jammer. Experimentales 3D Audio und bessere Latenz, auch mit vielen Teilnehmern. Benötigt die Installation des DS Clients. Anwendungsbereiche: Chöre, Orchester',
    audioTypeOv: 'OV-Technologie',
    audioTypeovDescription:
        'Übertragung mittels OV Technologie.  3D Audio und beste Latenz mit wenigen Teilnehmern. Benötigt die Installation des DS Clients oder die Verwendung einer OV-Box. Keine Unterstützung für Windows! Anwendungsbereiche: Ensembles, Bands',
    ...
    deleteGroupDescription:
        'Bitte bestätige, dass Du diese Gruppe und deren Teilnehmer wirklich entfernen willst.',
    deleteStage: 'Bühne enternen',
    deleteStageDescription:
        'Bitte bestätige, dass Du diese Bühne und deren Teilnehmer wirklich entfernen willst',
